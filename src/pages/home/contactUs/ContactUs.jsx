...
const ContactUs = () => {
    ...
    return (
        <div id='contactUs' className='bg-gray-200 mx-auto'>
            <div className="grid md:grid-cols-2 mx-auto items-center">
                <div className="flex flex-col  items-center justify-center md:mr-4 p-5">

                    <img src={image} alt="" />
                </div>
                <div className='p-5'>
                    <form onSubmit={handleSubmit} className=" rounded-lg  lg:pe-16">
